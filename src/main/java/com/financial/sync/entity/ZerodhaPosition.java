...
public class ZerodhaPosition {
    ...
    private Integer sellQuantquantity;
    ...
    @Column(name = "unrealised_pnl", precision = 15, scale = 2)
    private BigDecimal unrealisedPnl;
    
    @Column(name = "realised_pnl", precision = 15, scale = 2)
